...
This Privacy Notice for Paul Gerling ('we', 'us', or 'our'), describes how and why we might access, collect, store, use, and/or share ('process') your personal information when you use our services ('Services'), including when you:

- Visit our website at [https://saver-app.com](https://saver-app.com) or any website of ours that links to this Privacy Notice

- Download and use our mobile application (Saver), or any other application of ours that links to this Privacy Notice

- Engage with us in other related ways, including any marketing or events

Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at [contact@saver-app.dev](mailto:contact@saver-app.dev).
...
How do you exercise your rights? The easiest way to exercise your rights is by visiting [https://saver-app.com/data-request](https://saver-app.com/data-request), or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
...
[14. SHARED SPACES AND COLLABORATIVE CONTENT](#clausea)

[15. DISCORD BOT](#clauseb)

[16. BROWSER EXTENSIONS](#clausec)

[17. DO WE MAKE UPDATES TO THIS NOTICE?](#policyupdates)

[18. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?](#contact)

[19. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?](#request)
...
- user-generated content (tasks, habits, bookmarks, etc.)

- shared-space and collaboration data

- information about invited collaborators

Sensitive Information. We do not process sensitive information.

Payment Data. We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by RevenueCat and Paddle. You may find their privacy notice link(s) here: [https://www.revenuecat.com/privacy](https://www.revenuecat.com/privacy) and [https://www.paddle.com/legal/privacy](https://www.paddle.com/legal/privacy).
...
Our servers are located in the United States, Belgium, Netherlands and Germany. Regardless of your location, please be aware that your information may be transferred to, stored by, and processed by us in our facilities and in the facilities of the third parties with whom we may share your personal information (see '[WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?](#whoshare)' above), including facilities in the United States, and other countries.
...
- Email: [contact@saver-app.dev](mailto:contact@saver-app.dev)
...
If you have questions or comments about your privacy rights, you may email us at [contact@saver-app.dev](mailto:contact@saver-app.dev).
...
To exercise these rights, you can contact us by visiting [https://saver-app.com/data-request](https://saver-app.com/data-request), by emailing us at [support@saver-app.dev](mailto:support@saver-app.dev), or by referring to the contact details at the bottom of this document.
...
Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at [contact@saver-app.dev](mailto:contact@saver-app.dev). We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.
...
## 14. SHARED SPACES AND COLLABORATIVE CONTENT

The Services allow users to create shared spaces and collaborate with other users. Content added to a shared space, including tasks, bookmarks, habits, notes, comments, assignments, usernames, profile information, and activity information, may be visible to other authorized members of that space. Users should only share personal information that they are authorized to disclose. Space owners and administrators may manage membership, roles, permissions, and shared content. If a user leaves a shared space or deletes their account, content previously contributed to that space may remain available to other members where necessary to preserve the shared workspace, unless deletion is required by applicable law. Where appropriate, we may remove or anonymize information identifying the departing user. Users may request access to, correction of, or deletion of their personal information through the privacy-request methods described in this Privacy Policy.

<span id="clauseb"></span>

## 15. DISCORD BOT

When users interact with our Discord bot, we may process Discord account identifiers, server and channel identifiers, commands, and content intentionally submitted to the bot solely to provide, secure, and maintain the bot’s functionality.

<span id="clausec"></span>

## 16. BROWSER EXTENSIONS

We provide browser extensions for Google Chrome and Safari that allow users to save and manage bookmarks and other content through the Services. Depending on the permissions granted and the features used, the extensions may process the URL and title of the webpage the user chooses to save, selected text or content submitted by the user, the active tab when the user activates the extension, authentication information, and technical information necessary to operate and secure the extension. The extensions transmit this information to our services only when necessary to provide the requested functionality, such as saving a webpage to the user’s account or shared space. We do not use browsing activity for advertising, profiling, or purposes unrelated to the extension’s stated functionality. Browser permissions are used only for the purposes disclosed in this Privacy Policy and in the relevant extension-store listing. Users may disable or remove the extension through their browser settings.
...
If you have questions or comments about this notice, you may email us at [contact@paul-gerling.dev](mailto:contact@paul-gerling.dev) or contact us by post at:

Paul Gerling

Fischweg 4

Halle (Westfalen), Nordrheinwestfalen 33790
...
Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please visit: [https://saver-app.com/data-request](https://saver-app.com/data-request).
