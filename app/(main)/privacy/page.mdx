...
We provide browser extensions for Google Chrome and Safari that allow users to save and manage bookmarks through the Services. Depending on the permissions granted and the features used, the extensions may process the URL and title of the webpage the user chooses to save, the active tab when the user activates the extension, authentication information, and technical information necessary to operate and secure the extension. The extensions transmit this information to our services only when necessary to save a webpage to the user’s account or shared space. We do not use browsing activity for advertising, profiling, or purposes unrelated to the extension’s stated functionality. Browser permissions are used only for the purposes disclosed in this Privacy Policy and in the relevant extension-store listing. Users may disable or remove the extension through their browser settings.
